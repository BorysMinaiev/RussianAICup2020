...
public abstract class DebugData {
    ...
    public static class Primitives extends DebugData {
        ...
        public model.ColoredVertex[] getVertices() {
            return vertices;
        }

        public void setVertices(model.ColoredVertex[] vertices) {
            this.vertices = vertices;
        }

        private model.PrimitiveType primitiveType;

        public model.PrimitiveType getPrimitiveType() {
            return primitiveType;
        }

        public void setPrimitiveType(model.PrimitiveType primitiveType) {
    ...
    public static class PlacedText extends DebugData {
        ...
        public model.ColoredVertex getVertex() {
            return vertex;
        }

        public void setVertex(model.ColoredVertex vertex) {
            this.vertex = vertex;
        }
