...
public class EntityAction {
    ...
    public void setMoveAction(model.MoveAction moveAction) {
        this.moveAction = moveAction;
    }

    private model.BuildAction buildAction;

    public model.BuildAction getBuildAction() {
        return buildAction;
    }

    public void setBuildAction(model.BuildAction buildAction) {
        this.buildAction = buildAction;
    }

    private model.AttackAction attackAction;

    public model.AttackAction getAttackAction() {
        return attackAction;
    }

    public void setAttackAction(model.AttackAction attackAction) {
        this.attackAction = attackAction;
    }

    private model.RepairAction repairAction;

    public model.RepairAction getRepairAction() {
        return repairAction;
    }

    public void setRepairAction(model.RepairAction repairAction) {
