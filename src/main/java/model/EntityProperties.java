...
public class EntityProperties {
    ...
    public void setPopulationProvide(int populationProvide) {
    ...
    public void setPopulationUse(int populationUse) {
    ...
    public void setResourcePerHealth(int resourcePerHealth) {
    ...
    public void setAttack(model.AttackProperties attack) {
        this.attack = attack;
    }
    ...
    public void setRepair(model.RepairProperties repair) {
        this.repair = repair;
    }
