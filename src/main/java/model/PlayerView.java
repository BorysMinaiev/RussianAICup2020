...
public class PlayerView {
    ...
    public void setEntityProperties(java.util.Map<model.EntityType, model.EntityProperties> entityProperties) {
    ...
    public void setMaxPathfindNodes(int maxPathfindNodes) {
    ...
    public void setEntities(model.Entity[] entities) {
