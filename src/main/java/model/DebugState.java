...
public class DebugState {
    ...
    public model.Vec2Float getMousePosWindow() {
        return mousePosWindow;
    }

    public void setMousePosWindow(model.Vec2Float mousePosWindow) {
        this.mousePosWindow = mousePosWindow;
    }

    private model.Vec2Float mousePosWorld;

    public model.Vec2Float getMousePosWorld() {
        return mousePosWorld;
    }

    public void setMousePosWorld(model.Vec2Float mousePosWorld) {
    ...
    public model.Camera getCamera() {
        return camera;
    }

    public void setCamera(model.Camera camera) {
        this.camera = camera;
    }
